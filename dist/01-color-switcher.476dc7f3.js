...
var timerStartHandler = function timerStartHandler() {
...
var timerStopHandler = function timerStopHandler() {
  clearInterval(timerId);
  btnStart.removeAttribute('disabled'); // body.removeAttribute('style');
};
